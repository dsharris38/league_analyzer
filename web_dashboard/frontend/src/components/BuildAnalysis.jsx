...
export default function BuildAnalysis({ match, puuid }) {
    ...
    return (
        <div className="space-y-8">
            {/* Item Build Path */}
            <div>
                <h3 className="text-sm font-bold text-slate-400 uppercase mb-3">Item Build Path</h3>
                <div className="flex flex-wrap gap-4 items-center bg-[#010a13] p-4 rounded-lg border border-[#1e2328]">
                    ...
                    {(() => {
                        ...
                        return groups.map((group, groupIdx) => (
                            <div key={groupIdx} className="flex items-center">
                                <div className="flex gap-2 bg-[#1e2328] p-2 rounded border border-slate-700/50">
                                        ...
                                        return (
                                            <div key={itemIdx} className="flex flex-col items-center gap-1">
                                                <Tooltip content={itemData ? <ItemTooltip itemData={itemData} /> : null}>
                                                    <div className="w-10 h-10 bg-slate-800 rounded border border-slate-700 overflow-hidden relative group cursor-help">
            ...
            <div>
                <h3 className="text-sm font-bold text-slate-400 uppercase mb-3">Skill Order</h3>
                <div className="bg-[#010a13] p-4 rounded-lg border border-[#1e2328]">
                            ...
                            return (
                                <div key={skillSlot} className="flex items-center gap-2">
                                    ...
                                    <Tooltip content={abilityData ? <AbilityTooltip abilityData={abilityData} /> : `Ability ${key}`}>
                                        <div className="w-10 h-10 rounded border-2 border-white/20 overflow-hidden cursor-help shrink-0 bg-slate-800">
                                            {abilityIconUrl ? (
                                            ...
                                            return (
                                                <Tooltip key={i} content={isLeveled ? `Level ${level}: ${key}` : null}>
                                                    <div className={clsx(
                                                        ...
                                                        isLeveled
                                                            ? `${skillColors[key]} text-white border-white/30`
            ...
            <div>
                <h3 className="text-sm font-bold text-slate-400 uppercase mb-3">Runes</h3>
                <div className="bg-[#010a13] p-6 rounded-lg border border-[#1e2328]">
                    <div className="flex flex-col md:flex-row gap-8 md:gap-12 justify-center">

                        {/* Primary Runes */}
                        <div className="flex flex-col items-center">
                            <h4 className="text-[#f0e6d2] font-bold mb-4 text-lg tracking-wide">Primary Runes</h4>
                            {(() => {
                        ...
                        {/* Secondary Runes */}
                        <div className="flex flex-col items-center">
                            <h4 className="text-[#f0e6d2] font-bold mb-4 text-lg tracking-wide">Secondary</h4>
                            {(() => {
                                const allRunes = getAllRunes();
                        ...
                        {/* Stat Mods */}
                        <div className="flex flex-col items-center">
                            <h4 className="text-[#f0e6d2] font-bold mb-4 text-lg tracking-wide">Stat Mods</h4>
