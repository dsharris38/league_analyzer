...
export default function RankCard({ rankInfo, pastRanks }) {
    ...
    return (
        <div className="glass-panel rounded-xl p-5 h-full relative overflow-hidden group">
            ...
            <h3 className="text-cyan-400 text-xs font-bold uppercase mb-6 tracking-widest text-glow relative z-10">Current Rank</h3>
            ...
            <div className="flex items-center gap-5 mb-6 relative z-10">
                <div className="relative">
                    ...
                    {/* Level badge if we wanted, or just nothing */}
                </div>
