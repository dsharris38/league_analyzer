                ...
                <div className="grid gap-4">
                    {analyses.map((file) => (
                        <button
                            ...
                            className="group flex items-center justify-between p-5 bg-slate-800 hover:bg-slate-700 border border-slate-700 hover:border-blue-500/50 rounded-xl transition-all w-full text-left"
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-lg text-slate-200 group-hover:text-white">
                    ...
                    <div className="bg-slate-800 border border-slate-700 rounded-xl w-full max-w-md p-6 shadow-2xl">
                        ...
                        <form onSubmit={handleAnalyze} className="space-y-4">
                            ...
                            <button
                                type="submit"
                                disabled={analyzing}
                                className="w-full bg-blue-600 hover:bg-blue-500 disabled:bg-blue-600/50 disabled:cursor-not-allowed text-white font-bold py-3 rounded-lg transition-colors flex items-center justify-center gap-2"
                            >
                                {analyzing ? (
                                    <>
