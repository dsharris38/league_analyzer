    ...
    return (
        <div className="relative mb-2 group">
            ...
            <div className={clsx(
                ...
                {/* Participants List - Visible on PC (Laptops+), Compact on Laptop, Full on Desktop */}
                <div className="hidden lg:flex lg:w-40 xl:w-56 py-1 px-2 flex-row gap-1 text-[10px] border-l border-white/10 bg-black/20 items-center transition-all">
                    <div className="flex-1 flex flex-col justify-center gap-0.5 h-full">
                        {team100.map(p => (
                            <div key={p.puuid} className="flex items-center gap-1 w-full">
                                ...
                                <span
                                    className={clsx(
                                        "truncate block lg:w-16 xl:w-20 cursor-pointer hover:underline hover:text-cyan-400 transition-colors",
