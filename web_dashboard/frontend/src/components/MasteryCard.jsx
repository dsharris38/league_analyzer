    ...
    return (
        <div className="glass-panel rounded-xl p-5 h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar pr-2">
                ...
                <button className="w-full pt-2 text-[10px] text-slate-500 hover:text-cyan-400 transition-colors uppercase tracking-widest flex items-center justify-center gap-1 group pb-2">
